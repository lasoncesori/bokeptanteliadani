...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokeptanteliadani.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokeptanteliadani.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokeptanteliadani.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
...
<meta itemProp="duration" content={humanDuration(file.length)} />
